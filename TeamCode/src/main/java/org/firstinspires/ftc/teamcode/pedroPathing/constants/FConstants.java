...
public class FConstants {
    static {
        ...
        FollowerConstants.forwardZeroPowerAcceleration = -25.367247406230447;
        FollowerConstants.lateralZeroPowerAcceleration = -65.04629260625396;

        FollowerConstants.translationalPIDFCoefficients.setCoefficients(0.1, 0, 0.001, 0);
        FollowerConstants.useSecondaryTranslationalPID = false;
        FollowerConstants.secondaryTranslationalPIDFCoefficients.setCoefficients(0.1,0,0.01,0); // Not being used, @see useSecondaryTranslationalPID

        FollowerConstants.headingPIDFCoefficients.setCoefficients(1, 0, 0.0001, 0);
        FollowerConstants.useSecondaryHeadingPID = false;
        FollowerConstants.secondaryHeadingPIDFCoefficients.setCoefficients(2,0,0.1,0); // Not being used, @see useSecondaryHeadingPID

        FollowerConstants.drivePIDFCoefficients.setCoefficients(0.006, 0, 0.00002, 0.6, 0);
