...
public class ThreeWheelLocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.001956723322717459;//8192 * 1.37795 * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES = 0.0020127033027609155;//8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    public static double TURN_TICKS_TO_RADIANS = 0.00207;//8192 * 1.37795 * 2 * Math.PI * 0.5;
    ...
    public ThreeWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        leftEncoderPose = new Pose(0, 5.5, 0);
        rightEncoderPose = new Pose(0, -5.5, 0);
        strafeEncoderPose = new Pose(0, 0, Math.toRadians(90));

        hardwareMap = map;

        // TODO: replace these with your encoder ports
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "left_actuator")); //0
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "right_actuator")); //2
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "rightBack")); //3
